...
const Bio = () => {
  return (
    <section id="bio" className="w-full bg-[#faf9f6] flex justify-center py-16 sm:py-20 lg:py-30">
      <motion.div
      ...
      >
        <motion.div
          ...
          className="w-full lg:w-1/2 h-[320px] sm:h-[420px] lg:h-auto relative bg-[#ece8df]"
        >
          <img
            src="/aboutme.jpeg"
            alt="Anant"
        ...
        <motion.div
          variants={containerVariants}
          className="w-full lg:w-1/2 bg-[#3b372f] px-6 sm:px-10 lg:px-24 py-12 sm:py-16 lg:py-20 flex flex-col justify-center"
        >
          <motion.span
            variants={itemVariants}
            className="text-[11px] sm:text-[12px] tracking-[0.25em] text-[#b8b09b] mb-4"
          >
            ABOUT ME
          </motion.span>
          ...
          <motion.h2
            variants={itemVariants}
            className="text-[22px] sm:text-[24px] lg:text-[25px] font-bold text-[#f5f3ee] mb-6"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-[#d6d1c4] text-[15px] sm:text-[16px] leading-[1.7]"
          >
